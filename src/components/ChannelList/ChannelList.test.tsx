...
describe('ChannelList', () => {
  ...
  it('applies active styles to the selected channel', () => {
    ...
    expect(screen.getByRole('button', {name: /esl_sc2/i})).toHaveStyle('background-color: rgb(6, 157, 171)');
  });

  it('does not apply active styles to non-selected channels', () => {
    renderComponent();
    expect(screen.getByText(/storbeck/i)).not.toHaveStyle('background-color: rgb(6, 157, 171)');
  });
